    ...
    <section id ="other" className="relative max-w-[1280px] mx-auto p-8 md:p-12 font-sans text-gray-800">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left relative">
        <div className="relative z-20 mt-8 md:mt-0 md:w-2/3" data-aos="fade-up">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6 max-w-[800px] mx-auto">
          ...
          <p className="text-lg md:text-xl text-gray-500 mb-6 max-w-[800px] mx-auto">
            It’s time to stop chasing leads and start winning them.
          </p>

          <p className="text-xl md:text-2xl font-bold text-gray-800 mt-6">
