    ...
    <section>
      ...
      <div className="max-w-[1280px] mx-auto p-4 sm:p-6 font-sans text-gray-800 flex flex-col md:flex-row items-center md:items-start overflow-hidden">
        ...
        <div className="md:w-2/3 w-full md:pl-8" data-aos="fade-left">
          ...
          >
            <p>
              <strong>Sign-Up:</strong> Users create an account, entering
              business details and completing verification.
            </p>
            <p>
              <strong>Log-In:</strong> Users log in securely for platform
              access.
            </p>
            <p>
              <strong>Choose Subscription Plan:</strong> Select from weekly,
              monthly, or annual subscription options. Complete payment to
              unlock full platform features.
            </p>
            <p>
              <strong>Create a Shipment Request:</strong> Importers enter
              shipment specifics, submitting a request for quotes.
            </p>
            <p>
