...
export const HowItWorksSecond = () => {
  ...
  return (
    <div className="max-w-[1280px] mx-auto p-4 sm:p-6 font-sans text-gray-800 flex flex-col md:flex-row">
      ...
      >
        <img
          src={mainImage}
          alt="Main"
          className=" h-auto object-fill max-w-[80%] mx-auto md:mx-0"
        />
      </div>
      ...
      <div className="md:w-2/3 w-full md:pl-8" data-aos="fade-left">
        <div className="flex flex-col items-center md:flex-row md:items-center justify-center md:justify-start mb-4">
          ...
          <img
            src={second2}
            alt="Icon"
            className="mt-4 md:mt-0 md:ml-4 w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32"
          />
        </div>
