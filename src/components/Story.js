...
export const Story = () => {
  ...
  >
    ...
    <section
      ...
      data-aos="fade-up"
    >
      <h1 className="text-2xl md:text-3xl font-bold text-gray-800 leading-none pt-4 text-right md:text-right">
    ...
    <section
      ...
      data-aos-delay="200"
    >
      <h1 className="text-2xl md:text-3xl font-bold text-gray-800 leading-none p-11 text-right md:text-right">
        Logo
      </h1>
      <p className="text-lg md:text-xl text-gray-700 md:pl-6">
